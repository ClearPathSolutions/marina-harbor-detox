    ...
    <form onSubmit={onSubmit} noValidate className="min-w-0 rounded-4xl border border-navy-100 bg-white p-6 shadow-card sm:p-8">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input id="lf-c-name" name="name" type="text" autoComplete="name" required className={field} placeholder="Jane Doe" />
          {err("name")}
        </div>
        <div>
          <label htmlFor="lf-c-phone" className={labelCls}>Phone</label>
          <input id="lf-c-phone" name="phone" type="tel" autoComplete="tel" required className={field} placeholder="(415) 555-0123" />
          {err("phone")}
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        <input id="lf-c-email" name="email" type="email" autoComplete="email" className={field} placeholder="you@email.com" />
        {err("email")}
      </div>
