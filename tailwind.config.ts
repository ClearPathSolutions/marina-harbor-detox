...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      maxWidth: {
        // ONE page container, centred. Every band's inner content shares it, so
        // the header logo, a page title and the copy beneath it all sit on the
        // same left edge.
        content: "1200px",
        // Long-form reading measure. Centred inside the container rather than
        // pinned left, so a short article no longer leaves a column of dead
